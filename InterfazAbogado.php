...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container-fluid flex-grow-1 d-flex letra">
        <div class="row flex-grow-1 w-100">
            <div class="col-md-2 sidebar bg-light d-flex flex-column justify-content-center align-items-start p-3">
                <a href="VerCitasAbogado.php" class="btn btn-light w-100 mb-2">Ver Citas</a>
            </div>
