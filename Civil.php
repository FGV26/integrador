            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="http://localhost/INTEGRADOR/">
                        <img src="http://localhost/INTEGRADOR/src/img/civil.png" alt="Estudio Jurídico Ortiz y Asociados" width="200">
                    </a>
   ...
   <main>
        ...
        <section class="hero-section d-flex align-items-center">
            ...
            <div class="header-txt1" style=" width: 300px; ">
                            ...
                            <h1 style="font-size: 36px;">DERECHO CIVIL</h1>
                ...
                una imputación de un delito. </p>
                        ...
                        <div class="header-img">
                            <img src="src/img/civil.png" alt="" width="550px" height="350">
                        </div>
                        <h1>
                            <p1>
                            <div class="header-txt1" style=" width: 300px; ">
    ...
    <section class="socio-section bg-dark text-white py-5">
        ...
        <h2>DERECHO CIVIL</h2>
            <div class="row justify-content-center mt-4">
                <div class="col-md-6">
              <p>  El Derecho Civil es una rama del derecho</p> 
              <p> que regula las relaciones privadas entre individuos</p> 
            <p> y/o entidades. Comprende aspectos como el estado civil </p> 
              <p> de las personas, las relaciones familiares, las </p> 
              <p> obigaciones y contratos, la propiedad y demás derechos reales.</p>
              <p>Su finalidad es establecer un marco jurídico que garantice </p>
              <p>el orden y las justicia en las relaciones civiles,asegurando</p> 
                <p> el respeto a los derechos y deberes de cada persona dentro</p>
                <p> de la sociedad.</p> 
                </div>
            </div>
        </div>
